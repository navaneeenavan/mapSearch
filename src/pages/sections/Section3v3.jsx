...
const Section3v3 = () => {
  ...
  return (
    <div className="w-full h-full relative">
      <section
        id="section3"
        className="h-full w-full relative lg:px-[calc(100vw/12)] lg:p-52 justify-center flex flex-col-reverse lg:flex-row items-center"
      >
        <div className="w-full lg:w-[70vw] h-full">
          <div className="grid grid-cols-1 lg:flex lg:justify-center lg:items-center lg:h-screen p-8 lg:px-24 lg:pl-0 font-poppins gap-4 md:gap-8 lg:gap-10">

          <div className="lg:relative w-full lg:w-[25vw] px-12 lg:pr-0 flex flex-col items-end">
          <h1
          ...
          >
            <p className="lg:font-semibold">Pay general registration fee!</p>
            <IoIosArrowForward
            ...
            <div className="lg:w-[20rem] lg:absolute lg:justify-center lg:top-[7%] lg:left-[40%] p-4 space-y-2 events-text opacity-0 delay-100">
              <Link
                className="flex items-center space-x-4 lg:justify-center"
              ...
              <p className={`${condition} text-xs pb-2 lg:text-center lg:justify-center`}>
              ...
              <Link
                className="bg-blue-500 text-white w-fit px-4 lg:justify-center py-2 rounded-xl text-sm flex items-center group"
                to="/portal/event/?ctg=kriyative"
              >
            ...
            <div className="lg:w-[20rem] lg:justify-center lg:absolute lg:top-[30%] lg:left-[70%] p-4 space-y-2 events-text opacity-0 delay-100">
              ...
              <p className={`${condition} lg:text-center text-xs pb-2 text-center`}>
